...
export class DeviceServer {
  ...
  private static getServerPath(): string {
    // In development: __dirname is dist/main/adb/, need to go up 3 levels to desktop/
    const devPath = path.join(__dirname, '../../../resources/scrcpy-server');
